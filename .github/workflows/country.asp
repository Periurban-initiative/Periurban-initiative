	...
	<img align="left" src="img/title_country.gif"><BR><BR>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width=550 border=0>
        <TBODY>
          ...
          <TR> 
            <TD> 
			<form action="editscenario.asp" method="post" name="data">
                ...
                <TBODY>
                  <TR> 
					...
					<TABLE><TBODY>
					  <TR><TD align=right><SPAN class=hed10px><strong>Userid: </strong></SPAN></TD><TD><SPAN class=hed10px><%=session("Userid")%></SPAN></TD></TR>
					  <TR><TD align=right><SPAN class=hed10px><strong>Name: </strong></SPAN></TD><TD><SPAN class=hed10px><%=session("Name")%></SPAN></TD></TR>
					  <TR><TD align=right><SPAN class=hed10px><strong>Last Login: </strong></SPAN></TD><TD><SPAN class=hed10px><%=session("Lastlogin")%></SPAN></TD></TR>
					  <TR><TD align=right><SPAN class=hed12px><strong>Country of analysis: </strong></SPAN></TD><TD>
	<select name="title">
...
</SELECT></TD></TR></TBODY></TABLE><SPAN class=hed12px><strong>Please provide any notes regarding your analysis:</strong></SPAN>
<TEXTAREA NAME="desc" ROWS=7 COLS=65 STYLE="font-size : 11px; font-family : verdana" value=""><%=session("Desc")%></textarea><BR><DIV align="right"><INPUT type="submit" value="SUBMIT CHANGES"></DIV></TD>
                  </TR>
                </TBODY>
              </TABLE></FORM></TD>
          </TR></TD></TR>
